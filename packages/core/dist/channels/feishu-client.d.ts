...
export declare function getFeishuTenantAccessToken(instanceId?: string): Promise<string>;
export interface FeishuSendOptions {
    receiveId: string;
    receiveIdType?: 'open_id' | 'chat_id' | 'user_id';
    content: string;
}
export declare function sendFeishuMessage(options: FeishuSendOptions, instanceId?: string): Promise<void>;
export declare function sendFeishuReply(messageId: string, content: string, instanceId?: string): Promise<void>;
/** 构建 /agent 角色选择卡片并发送 */
...
export declare function sendFeishuHelpCard(messageId: string, helpText: string, instanceId?: string): Promise<void>;
...
export declare function sendFeishuReplyCard(messageId: string, card: Record<string, unknown>, instanceId?: string): Promise<void>;
/**
 ...
 */
export declare function getFeishuMessageResource(messageId: string, fileKey: string, resourceType?: 'file' | 'image', instanceId?: string): Promise<Buffer>;
 ...
 */
/** @param instanceId 方案 B：多实例时传入实例 ID */
export declare function replyFeishuImage(messageId: string, filePath: string, caption?: string, instanceId?: string): Promise<void>;
/**
 * 上传文件到飞书并回复文件消息
 * @param instanceId 方案 B：多实例时传入实例 ID
 */
export declare function replyFeishuFile(messageId: string, filePath: string, mimeType: string, caption?: string, instanceId?: string): Promise<void>;
