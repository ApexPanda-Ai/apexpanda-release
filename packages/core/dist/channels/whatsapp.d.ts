...
/** 文件直通：发送图片 */
export declare function sendWhatsAppImage(to: string, filePath: string, caption: string | undefined, phoneNumberId: string, accessToken: string, mimeType?: string): Promise<void>;
/** 文件直通：发送文档/音频/视频等 */
export declare function sendWhatsAppDocument(to: string, filePath: string, mimeType: string, caption: string | undefined, phoneNumberId: string, accessToken: string): Promise<void>;
export {};
